...
class BackgroundUi extends CustomPainter{
  ...
  liquidAnim = CurvedAnimation(
      parent: animation, curve: Curves.easeInOut, reverseCurve: Curves.easeInBack),
  ...
  blueAnim = CurvedAnimation(parent: animation, curve: const SpringCurve(),
  ...
  // orange animation class is below this line
  ...
  //orange paint animation starts here
