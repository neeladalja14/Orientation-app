...
//   Material MyItems(IconButton icon, String heading, int color, onPressed) {
//     return Material(
...
//                       child: IconButton(icon: color.[black],
//                         size: 30.0,
//                       ),
//                     ),
//                   ),
...
//           MyItems(
//               new IconButton(
//                   icon: new Icon(Icons.ondemand_video), onPressed: () {context.signOut();
//                     Navigator.of(context).push(AuthScreen.route);}),
//               "Campus Tour",
//               0xffed622b,
//               () {}),
